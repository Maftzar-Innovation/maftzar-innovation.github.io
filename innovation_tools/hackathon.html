...
<!--header - contains navigation bar and search bar-->
    ...
    <h2 class="page-header">האקתון</h2>
    <div class="text">
        <p>האקתון הוא אירוע יזמות מרתוני, מרוכז ואינטנסיבי המושתת על חוכמת ההמונים. המילה האקתון היא הלחם בין המילה פיצוח (Hack) למילה מרתון. האקתון דורש מיומנויות כמו עבודה בצוות, חשיבה יצירתית, יכולת פיתוח ועמידה בלוחות זמנים.
        </p>
        <h3>איך זה עובד?</h3>
        <p>
...
האקתון חיצוני, בו משתתף קהל חיצוני לארגון, כמו תוכניתנים, מדענים, אנשי מדיה או אף הציבור הרחב. האקתון כזה מאפשר לפתח פתרונות, על ידי "ייבוא" של ידע או כישורים שאין בארגון. מטרותיו של האקתון חיצוני יכולות להיות גם גיוס כוח אדם, פרסום ומיתוג, הטמעת מערכות וכיו"ב.
        ...
        <img src="../pics\HackathonPic.png" style="height: 40%; margin-right: 10%;">
    </div>
</body>
</html>