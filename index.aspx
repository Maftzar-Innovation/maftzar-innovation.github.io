     ...
     <div class="screen3">
      ...
      <div class="cards-container">
          ...
          <div class="card-rect">
            <h3>כתבות</h3>
            <p>
              יוזקייסים, סיכומים וטיפים קצרים שימושיים ומעניינים שמאפשרים ללמוד ולהכיר את עולם החדשנות, דוגמאות שמציגות איך החדשנות מייושמת בצה”ל ןבארגונים אחרים. וסיפורים מעוררי השראה.
            </p>
          </div>
      </div>

        <h3 class="events-header" style="width: 100%; text-align: center;">הזדמנויות חדשנות קרובות</h3>
        <div class="event-rect-container">
          <div class="event-rect">
          <p>29.11</p>
          <p>וובינר</p>
          </div>
          <div class="event-rect">
              ...
              <div class="event-rect">
                ...
                <div class="event-rect">
                  ...
                  <div class="contact-frame">
                    <span>
                      <p style="color: #25232e">צרו קשר</p>
